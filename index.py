...
from Classe.Mes_class import ExtensionFileOrganizer
...
mo_titre=CTkLabel(master=framedroite,text="BIENVENUE SUR FILES ORGANIZER",font=("arial",20),text_color="blue")
mo_titre.place(relx=0.5,rely=0.25,anchor="center")
...
button = CTkButton(master=framedroite,text="Selectionner un Dossier a Organisant",corner_radius=32,fg_color="#4158D0",hover_color="#000000",command=organization)
